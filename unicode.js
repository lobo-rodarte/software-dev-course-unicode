...
let swappedString = String.fromCharCode(inputString2.charCodeAt(inputString2.length - 1), inputString2.charCodeAt(1), inputString2.charCodeAt(2), inputString2.charCodeAt(3), inputString2.charCodeAt(4), inputString2.charCodeAt(0)); // Your code here
